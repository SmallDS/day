...
| `NEXT_PUBLIC_WALLPAPER_ENABLED` | 壁纸功能开关<br>0: 关闭壁纸功能<br>1: 开启壁纸功能 | `0` |
...
- 壁纸功能通过`NEXT_PUBLIC_WALLPAPER_ENABLED`环境变量控制
- 设置为`0`可完全禁用壁纸功能，保留默认渐变背景
- 设置为`1`则启用壁纸功能，显示必应每日壁纸
